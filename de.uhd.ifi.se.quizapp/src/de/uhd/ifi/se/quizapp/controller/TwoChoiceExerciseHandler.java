...
/** Handler for two choice exercises */
public class TwoChoiceExerciseHandler extends AbstractExerciseHandler {
	/** Data Manager */
	...
	protected HttpServletRequest handleEditingInChain(HttpServletRequest request) {
		...
		try {
			TwoChoiceExercise exercise = dataManager.getExercise(exerciseId);
