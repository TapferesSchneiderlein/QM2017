...
/** Servlet class for administrator */
...
public class AdministratorServlet extends HttpServlet {
	...
	public AdministratorServlet() {
		super();
		exerciseHandler = new TwoChoiceExerciseHandler(AbstractExerciseHandler.TWOCHOICE);
		sentencePartExerciseHandler = new SentencePartExerciseHandler(AbstractExerciseHandler.SENTENCEPART);
	...
	public HttpServletRequest handleDeleteInformationRequest(HttpServletRequest request, DataManager dataManager) {
		...
		try {
			dataManager.deleteInformation(informationId);
		} catch (ClassNotFoundException | SQLException e) {
			System.err.println(e);
			e.printStackTrace();
		}
	...
	public HttpServletRequest handleEditInformationRequest(HttpServletRequest request, DataManager dataManager) {
		...
		try {
			info = dataManager.getInformation(informationId);
		} catch (ClassNotFoundException | SQLException e) {
			System.err.println(e);
			e.printStackTrace();
		}
	...
	public HttpServletRequest handleUpdateInformationRequest(HttpServletRequest request, DataManager dataManager) {
		...
		Information info = new Information(informationId, name, text);
